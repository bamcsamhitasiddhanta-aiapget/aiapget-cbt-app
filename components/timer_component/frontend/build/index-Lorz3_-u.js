...
var _jsxFileName$1 = "C:/project1/timer-component/timer_component/frontend/src/MyComponent.tsx";
var MyComponent = ({ end_time, setStateValue }) => {
	const getRemaining = () => Math.max(0, Math.floor(end_time - Date.now() / 1e3));
	const [remaining, setRemaining] = (0, import_react.useState)(getRemaining());
...
var _jsxFileName = "C:/project1/timer-component/timer_component/frontend/src/index.tsx";
var reactRoots = /* @__PURE__ */ new WeakMap();
var MyComponentRoot = (args) => {
	const { data, parentElement, setStateValue } = args;
	const rootElement = parentElement.querySelector(".react-root");
	if (!rootElement) throw new Error("Unexpected: React root element not found");
	let reactRoot = reactRoots.get(parentElement);
	if (!reactRoot) {
		reactRoot = (0, import_client.createRoot)(rootElement);
		reactRoots.set(parentElement, reactRoot);
	}
	const { end_time } = data;
	reactRoot.render(/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(MyComponent, {
		setStateValue,
		end_time
	}, void 0, false, {
...
//#endregion
export { MyComponentRoot as default };

//# sourceMappingURL=index-Lorz3_-u.js.map